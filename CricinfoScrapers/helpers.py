...
def get_match_url_from_match_id(match_id):
    ...
    url = "http://stats.espncricinfo.com/ci/engine/match/{match_id}.html".format(
...
def get_series_id_from_match_id(match_id):
    return get_series_id_from_match_page(get_match_url_from_match_id(match_id))
